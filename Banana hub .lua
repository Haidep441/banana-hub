spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To skidder Hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join さま|bananaHub Community Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Tabs = {
    ...
    M = Window:AddTab({ Title = "Farming Tab", Icon = "" }),
    IQ = Window:AddTab({ Title = "Sub Farming Tab", Icon = "" }),
    SeaEvent = Window:AddTab({ Title = "Sea Event Tab", Icon = "" }),
    S = Window:AddTab({ Title = "Stats Tab", Icon = "" }),
    E = Window:AddTab({ Title = "ESP Tab", Icon = "" }),
    RA = Window:AddTab({ Title = "Raid Tab", Icon = "" }),
    LC = Window:AddTab({ Title = "Local Player Tab", Icon = "" }),
    Wld = Window:AddTab({ Title = "Sea TP Tab", Icon = "" }),
    SV = Window:AddTab({ Title = "Status and Server", Icon = "" }),
    D = Window:AddTab({ Title = "Fruit Tab", Icon = "" }),
    R = Window:AddTab({ Title = "Upgrade Race", Icon = "" }),
    C = Window:AddTab({ Title = "Misc Tab", Icon = "" }),
    ST = Window:AddTab({ Title = "Settings Tab", Icon = "" })
}
...
while wait(.1) do
    ...
    --------------------------------------------------------------------------------------------------------------------------------------------
    --Create Tabs
    local Farming = Tabs.M:AddSection("Farming")
    local listfastattack = {"Low Attack", "Normal Attack", " haidepzai Attack"}
	...
	if _G.FastAttackFaiFao_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.5
	elseif _G.FastAttackFaiFao_Mode == "Low Attack" then
		_G.Fast_Delay = 0.10
	elseif _G.FastAttackFaiFao_Mode == "haidepzai Super Attack" then
		_G.Fast_Delay = 0.01
	end
end)
    ...
    local ToggleLevel = Tabs.M:AddToggle("ToggleLevel", {Title = "Auto Level", Default = false})
    ...
    local ToggleCandy =
        Tabs.M:AddToggle("ToggleCandy", {Title = "Auto Farm Candy ( Only Max Level )", Default = false})
    ...
    local ToggleMobAura = Tabs.M:AddToggle("ToggleMobAura", {Title = "Mob Aura", Default = false})
    ...
    local ToggleCastleRaid =
        Tabs.M:AddToggle("ToggleCastleRaid", {Title = "Auto Castle Raid", Default = false})
    ...
    if Third_Sea then
        local ToggleChest =
            Tabs.M:AddToggle("ToggleChest", {Title = "Auto Chest Stop If Has Items [Tp]", Default = false})
    ...
    local ToggleChestTween = Tabs.M:AddToggle("ToggleChestTween", {Title = "Auto Chest [Tween]", Default = false})
    ...
    --------------------------------------------------------------------------------------------------------------------------------------------
    --Mastery
    local Mastery = Tabs.M:AddSection("Mastery Farm")
    ...
    local ToggleMasteryFruit = Tabs.M:AddToggle("ToggleMasteryFruit", {Title = "Auto BF Mastery", Default = false})
    ...
    local MiscFarm = Tabs.M:AddSection("Misc Farm")

    if Third_Sea then
        local ToggleBone = Tabs.M:AddToggle("ToggleBone", {Title = "Auto Bone", Default = false})
        ...
        local ToggleCake = Tabs.M:AddToggle("ToggleCake", {Title = "Auto Cake Prince", Default = false})
        ...
        local ToggleSpawnCake =
            Tabs.M:AddToggle("ToggleSpawnCake", {Title = "Auto Spawn Cake Prince", Default = true})
    ...
    if Second_Sea then
        local ToggleVatChatKiDi = Tabs.M:AddToggle("ToggleVatChatKiDi", {Title = "Auto Ectoplasm", Default = false})
    ...
    local boss = Tabs.M:AddSection("Boss Farm")
    ...
    local ToggleAutoFarmBoss = Tabs.M:AddToggle("ToggleAutoFarmBoss", {Title = "Kill Boss", Default = false})
    ...
    local Material = Tabs.M:AddSection("Material Farm")
    ...
    local ToggleMaterial = Tabs.M:AddToggle("ToggleMaterial", {Title = "Auto Material", Default = false})
    ...
    if Third_Sea then
        local RoughSea = Tabs.M:AddSection("?? Kitsune ??")

        local ToggleEspKitsune =
            Tabs.M:AddToggle("ToggleEspKitsune", {Title = "Esp Kitsune Island", Default = false})
        ...
        local ToggleTPKitsune =
            Tabs.M:AddToggle("ToggleTPKitsune", {Title = "Tween To Kitsune Island", Default = false})
        ...
        local ToggleCollectAzure =
            Tabs.M:AddToggle("ToggleCollectAzure", {Title = "Collect Azure Ambers", Default = false})
    ...
    if Third_Sea then
        local RoughSea = Tabs.M:AddSection("Rough Sea")

        local ToggleSailBoat = Tabs.M:AddToggle("ToggleSailBoat", {Title = "Auto Buy Ship", Default = false})
        ...
        local ToggleTerrorshark =
            Tabs.M:AddToggle("ToggleTerrorshark", {Title = " Kill Terrorshark", Default = false})
        ...
        local TogglePiranha = Tabs.M:AddToggle("TogglePiranha", {Title = " Kill Piranha", Default = false})
        ...
        local ToggleShark = Tabs.M:AddToggle("ToggleShark", {Title = " Kill Shark", Default = false})
        ...
        local ToggleFishCrew = Tabs.M:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew", Default = false})
        ...
        local ToggleShip = Tabs.M:AddToggle("ToggleShip", {Title = "Kill Ship", Default = false})
        ...
        local ToggleGhostShip = Tabs.M:AddToggle("ToggleGhostShip", {Title = "Kill Ghost Ship", Default = false})
        ...
        local AutoElite = Tabs.M:AddSection("Elite Hunter Farm")

        local ToggleElite = Tabs.M:AddToggle("ToggleElite", {Title = "Auto Elite Hunter", Default = false})
    ...
    if Third_Sea then
        local Sea = Tabs.M:AddSection("Sea Beast")

        local ToggleSeaBeAst = Tabs.M:AddToggle("ToggleSeaBeAst", {Title = "Auto Sea Beast", Default = false})
        ...
        local ToggleAutoW = Tabs.M:AddToggle("ToggleAutoW", {Title = "Auto Press W", Default = false})
        ...
        local AutoMysticIsland = Tabs.M:AddSection("Mirage Island")

        local ToggleTweenMirageIsland =
            Tabs.M:AddToggle("ToggleTweenMirageIsland", {Title = "Tween To Mirage Island", Default = false})
        ...
        local ToggleTweenGear = Tabs.M:AddToggle("ToggleTweenGear", {Title = "Tween To Gear", Default = false})
        ...
        local Togglelockmoon =
            Tabs.M:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill", Default = false})
        ...
        local ToggleMirage = Tabs.M:AddToggle("ToggleMirage", {Title = "Auto Mirage Island", Default = false})
        ...
        local AutoW = Tabs.M:AddToggle("AutoW", {Title = "Auto Press W", Default = false})
        AutoW:OnChanged(
            function(Value)
                _G.AutoW = Value
            end
    ...
    local Items = Tabs.M:AddSection("Items Farm")

    if Third_Sea then
        local ToggleHallow =
            Tabs.M:AddToggle("ToggleHallow", {Title = "Auto Hallow Scythe [Fully]", Default = false})
        ...
        local ToggleYama = Tabs.M:AddToggle("ToggleYama", {Title = "Auto Get Yama", Default = false})
        ...
        local ToggleTushita = Tabs.M:AddToggle("ToggleTushita", {Title = "Auto Tushita", Default = false})
        ...
        local ToggleHoly = Tabs.M:AddToggle("ToggleHoly", {Title = "Auto Holy Torch", Default = false})
...
if Second_Sea then
    local ToggleFactory = Tabs.M:AddToggle("ToggleFactory", {Title = "Auto Farm Factory", Default = false})
...
if Third_Sea then
    local ToggleCakeV2 = Tabs.M:AddToggle("ToggleCakeV2", {Title = "Kill Dought King [Need Spawn]", Default = false})
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.M:AddToggle("ToggleHakiColor", {Title = "Buy Haki Color", Default = false})
...
if Second_Sea then
    local ToggleSwordLengend =
        Tabs.M:AddToggle("ToggleSwordLengend", {Title = "Buy Sword Lengendary", Default = false})
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Setting
local SettingFarm = Tabs.ST:AddSection("Setting Farming")

local ToggleFastAttack = Tabs.ST:AddToggle("ToggleFastAttack", {Title = " Turn On Fast Attack", Default = true})

ToggleFastAttack:OnChanged(
    function(Value)
        _G.FastAttackhdz = Value
    end
)
...
spawn(
    function()
        while wait(0.4) do
            pcall(
                function()
                    if _G.FastAttackhaidz then
                        repeat
                            wait(_G.Fast_Delay)
                            AttackNoCD()
                        until not _G.FastAttackhaidz
                    end
                end
            )
        end
...
local ToggleBringMob = Tabs.ST:AddToggle("ToggleBringMob", {Title = " Enable Bring Mob / Magnet", Default = true})
...
local ToggleBypassTP = Tabs.ST:AddToggle("ToggleBypassTP", {Title = "Enable Bypass Tp", Default = false})
...
local ToggleRemove = Tabs.ST:AddToggle("ToggleRemove", {Title = " Enable Remove Dame Text", Default = true})
...
local ToggleRemoveNotify =
    Tabs.ST:AddToggle("ToggleRemoveNotify", {Title = " Enable Remove All Notify", Default = false})
...
local ToggleWhite = Tabs.ST:AddToggle("ToggleWhite", {Title = " Enable White Screen", Default = false})
...
local SKill = Tabs.ST:AddSection("Skill Mastery")
local ToggleZ = Tabs.ST:AddToggle("ToggleZ", {Title = "Skill Z", Default = true})
ToggleZ:OnChanged(
    function(Value)
        SkillZ = Value
    end
...
local ToggleX = Tabs.ST:AddToggle("ToggleX", {Title = "Skill X", Default = true})
ToggleX:OnChanged(
    function(Value)
        SkillX = Value
    end
...
local ToggleC = Tabs.ST:AddToggle("ToggleC", {Title = "Skill C", Default = true})
ToggleC:OnChanged(
    function(Value)
        SkillC = Value
    end
...
local ToggleV = Tabs.ST:AddToggle("ToggleV", {Title = "Skill V", Default = true})
ToggleV:OnChanged(
    function(Value)
        SkillV = Value
    end
...
local ToggleF = Tabs.ST:AddToggle("ToggleF", {Title = "Skill F", Default = false})
ToggleF:OnChanged(
    function(Value)
        SkillF = Value
    end
...
local Pos = Tabs.ST:AddSection("Distance Farm")
...
--Stats
local ToggleMelee = Tabs.S:AddToggle("ToggleMelee", {Title = "Auto Melee", Default = false})
...
local ToggleDe = Tabs.S:AddToggle("ToggleDe", {Title = "Auto Defense", Default = false})
ToggleDe:OnChanged(
    function(Value)
...
local ToggleSword = Tabs.S:AddToggle("ToggleSword", {Title = "Auto Sword", Default = false})
...
local ToggleGun = Tabs.S:AddToggle("ToggleGun", {Title = "Auto Gun", Default = false})
ToggleGun:OnChanged(
    function(Value)
...
local ToggleFruit = Tabs.S:AddToggle("ToggleFruit", {Title = "Auto Demon Fruit", Default = false})
...
local ToggleTeleport = Tabs.LC:AddToggle("ToggleTeleport", {Title = "Teleport To Player", Default = false})
...
local ToggleQuanSat = Tabs.LC:AddToggle("ToggleQuanSat", {Title = "Spectate Player", Default = false})
...
local Teleport = Tabs.LC:AddSection("Combat")

local ToggleAimBotSkill =
    Tabs.LC:AddToggle("ToggleAimBotSkill", {Title = "Aimbot Skill ( Bug Wait Fix )", Default = false})
...
local ToggleAimbotGun =
    Tabs.LC:AddToggle("ToggleAimbotGun", {Title = "Aimbot Gun ( Bug Wait Fix )", Default = false})
...
--------------------------------------------------------------------------------------------------------------------------------------------
--[[
local Mastery = Tabs.LC:AddSection("Misc PVP")

local ToggleSoruNOCD = Tabs.LC:AddToggle("ToggleSoruNOCD", {Title = "Soru No Cooldown", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
local ToggleGeppoNoCD = Tabs.LC:AddToggle("ToggleGeppoNoCD", {Title = "Geppo No Cooldown", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
local ToggleDashNoCD = Tabs.LC:AddToggle("ToggleDashNoCD", {Title = "Dash No Cooldown", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
local ToggleSpeedHack = Tabs.LC:AddToggle("ToggleSpeedHack", {Title = "Speed Hack", Default = true })
...
function InfAbility()
    if _G.SpeedHack then
        if not game.Players.LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Texture = "rbxassetid://124257657238321"
...
--------------------------------------------------------------------------------------------------------------------------------------------
local ToggleWalkOnWater = Tabs.LC:AddToggle("ToggleWalkOnWater", {Title = "Wakl On Water", Default = true })
...
-----------------------------------------------------------------------------------------------------------------------------------------------
--Teleport
local Teleport = Tabs.Wld:AddSection("Teleport World")
...
local Mastery = Tabs.Wld:AddSection("Teleport Island")
...
local ToggleIsland = Tabs.Wld:AddToggle("ToggleIsland", {Title = "Teleport", Default = false})
...
local ToggleFruit = Tabs.D:AddToggle("ToggleFruit", {Title = "Buy Fruit Sniper", Default = false})
ToggleFruit:OnChanged(
    function(Value)
...
local ToggleStore = Tabs.D:AddToggle("ToggleStore", {Title = "Store Fruit", Default = false})
...
local ToggleRandomFruit = Tabs.D:AddToggle("ToggleRandomFruit", {Title = "Random Fruit", Default = false})
...
local ToggleCollect = Tabs.D:AddToggle("ToggleCollect", {Title = "Collect Devil Fruit", Default = false})
...
local Mastery = Tabs.D:AddSection("Esp")

local ToggleEspPlayer = Tabs.D:AddToggle("ToggleEspPlayer", {Title = "Esp Player", Default = false})
...
local ToggleEspFruit = Tabs.D:AddToggle("ToggleEspFruit", {Title = "Esp Devil Fruit", Default = false})
...
local ToggleEspIsland = Tabs.D:AddToggle("ToggleEspIsland", {Title = "Esp Island", Default = false})
...
local ToggleEspFlower = Tabs.D:AddToggle("ToggleEspFlower", {Title = "Esp Flower", Default = false})
...
local ToggleBuy = Tabs.RA:AddToggle("ToggleBuy", {Title = "Buy Chip", Default = false})
ToggleBuy:OnChanged(
    function(Value)
...
local ToggleStart = Tabs.RA:AddToggle("ToggleStart", {Title = "Start Raid", Default = false})
...
local ToggleKillAura = Tabs.RA:AddToggle("ToggleKillAura", {Title = "Kill Aura", Default = false})
...
local ToggleNextIsland = Tabs.RA:AddToggle("ToggleNextIsland", {Title = "Next Island", Default = false})
...
local ToggleAwake = Tabs.RA:AddToggle("ToggleAwake", {Title = "Auto Awake", Default = false})
...
local ToggleGetFruit = Tabs.RA:AddToggle("ToggleGetFruit", {Title = "Get Fruit Low Bely", Default = false})
...
local Mastery = Tabs.RA:AddSection("Law Raid")

local ToggleLaw = Tabs.RA:AddToggle("ToggleLaw", {Title = "Auto Law", Default = false})
...
local Mastery = Tabs.R:AddSection("Auto Race")
...
local Mastery = Tabs.R:AddSection("Auto Train")
...
local ToggleRandomBone = Tabs.SH:AddToggle("ToggleRandomBone", {Title = "Random Bone", Default = false})
...
local Mastery = Tabs.SH:AddSection("Fighting Styles")
...
local Mastery = Tabs.SH:AddSection("Misc Items")
...
local Mastery = Tabs.C:AddSection("Team")
...
local Mastery = Tabs.C:AddSection("Open Ui")
...
local Mastery = Tabs.C:AddSection("Troll")
...
Tabs.C:AddButton(
    {
        ...
        Callback = function()
            for i, v in pairs(game:GetObjects("rbxassetid://124257657238321")[1]:GetChildren()) do
...
local Mastery = Tabs.C:AddSection("Misc")

local ToggleRejoin = Tabs.C:AddToggle("ToggleRejoin", {Title = "Auto Rejoin", Default = true})
...
local Mastery = Tabs.C:AddSection("Kaitun Cap")
            ...
            for k, v in pairs(cac) do
                if
                 ...
                 then
                    ...
                    huhu.Image = "rbxassetid://82611754073031"
...
local Mastery = Tabs.C:AddSection("Day")
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.SV:AddSection("Thid Sea Please !!!")
end

if Third_Sea then
    local ToggleFindMoon = Tabs.SV:AddToggle("ToggleFindMoon", {Title = "Find Full Moon", Default = false})
    ...
    local ToggleMirageIsland = Tabs.SV:AddToggle("ToggleMirageIsland", {Title = "Find Mirage Island", Default = false})
